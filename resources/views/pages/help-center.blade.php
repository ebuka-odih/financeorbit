            ...
            <div class="uk-container">
                <div class="uk-grid">
                    <div class="uk-width-1-1 in-content-10">
                        ...
                        <div class="uk-grid-divider uk-child-width-1-3@m uk-child-width-1-2@s uk-margin-medium-top uk-grid" data-uk-grid="">
                            <div class="uk-first-column">
                                <h3 class="uk-heading-bullet"><a class="uk-link-text" href="#">How-tos &amp; Tutorials</a></h3>
                                <div class="uk-grid uk-grid-small" data-uk-grid="">
                                    <div class="uk-width-expand@m uk-first-column">
                                        <p>Read our Instructional Tutorials or watch our videos provided here.</p>
                                    </div>
                            ...
                            <div class="uk-visible@m">
                                ...
                                <div class="uk-grid uk-grid-small" data-uk-grid="">
                                    <div class="uk-width-expand@m uk-first-column">
                                        <p>Get help on the security of your account to avoid compromise.</p>
                                    </div>
                                    <div class="uk-width-auto@m">
                            ...
                            <div>
                                ...
                                <div class="uk-grid uk-grid-small" data-uk-grid="">
                                    <div class="uk-width-expand@m uk-first-column">
                                        <p>Open a support ticket to enable us serve you better. You can write us at <b>support@algo-trade.co</b></p>
                                    </div>
                                    <div class="uk-width-auto@m">
                                ...
                                <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                                    <div class="uk-grid" data-uk-grid="">
                                        ...
                                        <div class="uk-width-expand@m in-margin-small-top@s">
                                            <h4 class="uk-margin-small-bottom">Getting started with our trading platform</h4>
                            ...
                            <div class="uk-grid-margin uk-first-column">
                                <a href="#" class="uk-card uk-card-small uk-card-default uk-card-body uk-border-rounded uk-display-block">
                                    <div class="uk-grid" data-uk-grid="">
                                        ...
                                        <div class="uk-width-expand@m in-margin-small-top@s">
                                            <h4 class="uk-margin-small-bottom">Trading Signals and Charts</h4>
