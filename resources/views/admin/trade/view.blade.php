                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    @endif
                                        ...
                                        <form action="{{ route('admin.setTrade', $trade->id) }}" method="POST">
                                            @csrf
                                            {{--                            @method('PATCH')--}}
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" class="form-control" name="profit" value="{{ old('profit', optional($trade)->profit) }}">
                                                </div>
                                                <div class="col-lg-6">
                                                    <label for="">Select Percent</label><span class="badge bg-primary m-4"> {{ $trade->percent }}</span>
