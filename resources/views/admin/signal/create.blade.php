        ...
        <div class="content">
            ...
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    ...
                    <button type="button" class="btn btn-primary push" data-bs-toggle="modal" data-bs-target="#modal-block-normal">Add Signal</button>
                    ...
                    <form action="{{ route('admin.signal.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="block-content">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-2 col-lg-12">
                                    <label class="form-label" for="example-text-input">Lot Size</label>
                                    <input type="text" class="form-control" id="example-text-input" name="lot" >
                                </div>
                                <div class="mb-2 col-lg-12">
